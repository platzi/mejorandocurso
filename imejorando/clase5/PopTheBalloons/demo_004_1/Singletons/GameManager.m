...
-(void)preLoadSFX
{
    ...
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSfxBalloonPop];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSfxBalloonDeflate];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSfxExplosion];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSfxClockTick];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSfxCloudTap];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSFXFail1];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSFXFail2];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSFXWin1];
    [[SimpleAudioEngine sharedEngine] preloadEffect:kSFXWin2];
}
